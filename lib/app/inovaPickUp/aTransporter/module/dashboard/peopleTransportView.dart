...
import 'package:enerren/app/angkut/aTransporter/module/dashboard/angkutPresenter.dart';
import 'package:enerren/app/angkut/aTransporter/module/dashboard/viewModel.dart';
...
class PeopleTransportView extends View with AngkutPresenter {
  ...
  String notificationAnimationAsset;
  ...
  PeopleTransportView({
    ...
    this.notificationAnimationAsset,
  });
