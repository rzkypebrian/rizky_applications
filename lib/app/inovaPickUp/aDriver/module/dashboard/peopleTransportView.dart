...
class PeopleTransportView extends View with AngkutPresenter {
  ...
  final String animationScoreAssets;
  final String animationNotificationAssets;
  ...
  PeopleTransportView({
    ...
    this.onTapScore,
    this.logoAssets,
    this.animationScoreAssets,
    this.animationNotificationAssets,
  });
            ...
            Align(
              ...
              child: Container(
                ...
                child: SvgPicture.asset(
                  logoAssets ?? "assets/angkut/logo_angkut_horizontal.svg",
                  width: 100,
                ),
              ),
            ),
  ...
  List<MenuModel> menuItems() {
    return <MenuModel>[
      ...
      MenuModel(
          ...
          immageAssetUrl: "assets/angkut/angkut_icon_menu_contacts.svg",
          onTap: () {
            super.showModalCantact();
          },
          icon: FontAwesomeRegular(FontAwesomeId.fa_plus)),
    ];
  }
