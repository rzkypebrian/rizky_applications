...
class View extends PresenterState {
  ...
  List<Widget> listCComponent() {
    return <Widget>[
      inputNumberOfDoseReceived(),
      inputNumberOfDoseRejected(),
    ];
  }
  ...
  Widget inputNumberOfDoseReceived() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        Text(
          "${System.data.resource.numberOf} ${System.data.resource.doseOfVaccineReceived}",
        ...
        Container(
          ...
          child: InputComponent.inputTextWithCorner(
            controller: numberOfVaccineReceivedController,
  ...
  Widget inputNumberOfDoseRejected() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        SizedBox(
        ...
        Text(
          "${System.data.resource.numberOf} ${System.data.resource.doseOfVaccineRejected}",
          style: System.data.textStyleUtil.mainLabel(),
        ),
        SizedBox(
          height: 15,
