...
Map<String, WidgetBuilder> routes = <String, WidgetBuilder>{
  ...
  RouteName.detailuangJalan: (BuildContext context) {
    ...
    return detailuangJalan.Presenter(
      tripAllowanceSummary: arg[ParamName.AngkutBudgetOperationModel],
    );
  },
  ...
  RouteName.chat: (BuildContext context) {
    ...
    return chat.Presenter(
      ...
      senderId: System.data.getLocal<LocalData>().user.transporterId,
      senderName: System.data.getLocal<LocalData>().user.transporterName,
      senderTypeId: 3,
