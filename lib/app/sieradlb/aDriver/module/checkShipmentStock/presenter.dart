...
abstract class PresenterState extends State<Presenter> {
  ...
  InputComponentTextEditingController numberOfLiveBirdController =
  ...
  void initState() {
    super.initState();
    try {
      numberOfLiveBirdController.text = widget.shipment
  ...
  bool validateNumberOfDoc() {
    if (numberOfLiveBirdController.content.toString().isNullOrEmpty()) {
      numberOfLiveBirdController.setStateInput = StateInput.Error;
      return false;
    } else {
      numberOfLiveBirdController.setStateInput = StateInput.Enable;
      return null;
    }
  }
      ...
      try {
        widget.onSuccess(
          ...
          new SieradDeliverStock(
            ...
            qtyLiveBirdReceived: int.parse(numberOfLiveBirdController.content),
          ),
        );
      } catch (e) {
        loadingController.stopLoading(
