...
import 'package:enerren/app/sieradlb/aTransporter/route.dart' as route;
import 'package:enerren/app/sieradlb/util/ColorUtil.dart';
import 'package:enerren/app/sieradlb/util/ApiEndPointUtil.dart';

void main() {
  System.data.colorUtil = ColorUtil().sieradLBTransporterColor();
  ...
  System.data.oneSignalMessaging = new OneSignalMessaging(
    appId: "39565a14-a8d5-4aa8-b734-596c188797aa",
