...
import 'package:enerren/app/sieradlb/aCustomer/route.dart' as route;

Future<void> main() async {
  System.data.colorUtil = ColorUtil().sieradLBCustomerColor();
  ...
  System.data.apiEndPointUtil = ApiEndPointUtil().sieradLBCustomerApiEndPoimt();
  System.data.oneSignalMessaging = new OneSignalMessaging(
    appId: "94d51865-1a6b-47e3-b5ff-c43f3b1e19c0",
