...
class TmsView extends View with TmsPresenter {
  bool showTmsLogo = false;
  String companyLogoAssets;
  String image1;
  String image2;
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Align(
                          ...
                          child: Container(
                            child: ranking(width: 250, value: 30),
                          ),
                        ),
                      ],
                    ),
      ...
      child: Stack(
        children: <Widget>[
          ...
          menu.Presenter(
              ...
              heigth: MediaQuery.of(context).size.height / 2 - 30,
              menus: menuItems),
        ],
      ),
    );
  ...
  Widget company() {
    return Container(
      ...
      child: SvgPicture.asset(
        companyLogoAssets ?? "assets/tms/logo_tms.svg",
        height: 30,
      ),
    );
  }
